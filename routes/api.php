...
Route::prefix('atzicay/v1')->group(function () {
    ...
    Route::post('/solveTheWord',[SolveTheWordController::class,'createSolveTheWord']);
    Route::post('/solveTheWord', [SolveTheWordController::class,'getAllSolveTheWord']);
    Route::post('/solveTheWord', [SolveTheWordController::class,'getSolveTheWordById']);
    Route::post('/solveTheWord', [SolveTheWordController::class,'updateSolveTheWord']);
    Route::post('/solveTheWord', [SolveTheWordController::class,'deleteSolveTheWord']);
});